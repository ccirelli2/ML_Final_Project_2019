...
s2.test = s2.100k.nolimits_ran[train_nrows_100k: length(s2.100k.nolimits_ran) ,]
s3.test = s3.250k.nolimits_ran[train_nrows_250k: length(s3.250k.nolimits_ran), ]
s4.test = s4.50k.wlimits_ran[  train_nrows_50k:   length(s1.50k.nolimits_ran), ]
s5.test = s5.100k.wlimits_ran[ train_nrows_100k: length(s2.100k.nolimits_ran) ,]
s6.test = s6.250k.wlimits_ran[ train_nrows_250k: length(s3.250k.nolimits_ran) ,]


## M1:    MULTILINEAR REGRESSION_______________________________________________________________________

# Train Simple Model
m3.mlr = lm(duration ~ ., data = s6.train)
